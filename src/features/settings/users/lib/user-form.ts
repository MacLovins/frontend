...
export const roleItems = Object.values(UserOutRole).map((role) => ({
  value: role,
...
export const newUserValues: CreateUserValues = {
  email: "",
  full_name: "",
  role: "sales",
  password: "",
...
export const editUserSchema = z.object({
  ...
  password: z
    .string()
    .refine(
      (value) => value === "" || value.length >= MIN_PASSWORD,
      copy.validation.password
    ),
})
...
export const displayName = (user: UserOut) =>
