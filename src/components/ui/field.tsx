...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-1.5 data-[variant=label]:text-[13px] data-[variant=label]:font-normal data-[variant=label]:text-text-secondary data-[variant=legend]:text-sm data-[variant=legend]:font-bold data-[variant=legend]:text-black",
        className
      )}
      {...props}
    />
...
const fieldVariants = cva(
  "group/field flex w-full gap-1.5 data-[invalid=true]:text-negative-strong",
  {
    variants: {
      orientation: {
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-sm font-semibold text-black group-data-[disabled=true]/field:opacity-50",
        className
      )}
      {...props}
    />
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-xs font-normal text-negative-strong", className)}
      {...props}
    >
      {content}
    </div>
